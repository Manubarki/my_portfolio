...
const milestones = [
  { company: "Atlan", period: "Jun 2023 – Present", role: "Recruiter → Lead Recruiter → Talent Partner", detail: "Building Engineering, Product & Design teams for startups to global enterprises", achievements: ["Frontend Eng team 2→8, Backend & Platform eng scaling", "Product team 6→15, Design 3→10", "7-8 senior roles (P4+ incl. Director) closed per quarter", "4/4 performance rating & promotion within first year"] },
